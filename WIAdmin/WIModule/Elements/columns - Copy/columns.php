...
class columns 
{
  ...
  public function mod_name()
  {
    ...
    <ul class="stageColumn" data-hover-tag="Column" id="columnx" data-col-width="100%" style="width:100%; float:left;height:50px;">
    ...
    echo '</li>
      ...
      <ul class="drop" id="feature" style="height:50px;"">
      </ul>
      <li class="stageFields fieldTypeButton firstField LastField" data-hover-tag="Field" id="field">
      <div class="fieldActions groupActions" id="right"></div>
