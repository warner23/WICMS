...
class columns 
{
  ...
  {
    echo '<li class="stageRow" data-hover-tag="Column" data-editing-hover-tag="Editing Column" id="dropStage" data-mod-tag="column">
    <div class="rowActions groupActions" id="left">';
    self::LgroupActions();
   ...
   echo ' </div>
    ...
    <ul class="stageColumn" data-hover-tag="Column" id="columnx" data-col-width="100%" style="width:100%; float:left;height:50px;padding:0;">
      <li class="columnsActions groupActions" id="middle">';
    self::MgroupActions();
    ...
    echo '</li>
      ...
      <div style="width:100%">
      <ul class="drop" id="feature" style="height:50px;padding:0;width:50%;float:left;"></ul>
      <ul class="drop" id="features" style="height:50px;padding:0;width:50%;float:left;"></ul>
      </div>
