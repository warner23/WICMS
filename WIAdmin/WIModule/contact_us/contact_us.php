...
class Contact_Us 
{
  ...
  public function editPageContent($page_id)
  {
    ...
    if ($lsc > 0) {
        ...
        <div class="col-sm-1 col-lg-2 col-md-2 col-xl-2 col-xs-2 sidenav" id="sidenavL">;
    ...
    if ($lsc && $rsc > 0) {
      <div class="col-lg-10 col-md-8 col-sm-8 block" id="block"><div class="col-lg-12 col-md-8 col-sm-8" id="Mid">;
    }else if($rsc > 0){
      <div class="col-lg-10 col-md-8 col-sm-8 block" id="block"><div class="col-lg-12 col-md-8 col-sm-8" id="Mid">;

     }else{
    <div class="col-lg-12 col-md-12 col-sm-12 block" id="block"><div class="col-lg-12 col-md-12 col-sm-12" id="Mid">;
    }

      <div class="col-lg-12 col-md-12 col-sm-12 mod" id="$mod_name" >
