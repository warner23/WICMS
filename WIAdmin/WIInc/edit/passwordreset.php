...
<html lang="en"> 
    <head>
        ...
        <title><?= trans('password_reset'); ?> | WI</title>
    ...
    <body>
        ...
        <script type="text/javascript" src="WICore/WIJ/asengine.js"></script>
        <script type="text/javascript" src="WICore/WIJ/passwordreset.js"></script>
