...
.off{
 ...
 <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <div class="col-lg-8 col-dm-3 col-xs-3 col-sm-3">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-xs-6 col-xl-12">
                          ...
                          <div class="wrap">
                              <ul class="wrapper">
                                  <li class="col-lg-4 col-dm-3 col-xs-3 col-sm-3">Name</li>
                                  <li class="col-lg-4 col-dm-3 col-xs-3 col-sm-3">Edit</li>
                                  <li class="col-lg-4 col-dm-3 col-xs-3 col-sm-3">Delete</li>
                              </ul>
                          </div>
