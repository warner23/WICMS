...
if (isset($_FILES)) {
	if (isset($_FILES['file'])) {
		...
		$imgs     = "../../WIMedia/Img/contents/" . basename($_FILES['file']['name']);
		$vids     = "../../WIMedia/Vid/contents/" . basename($_FILES['file']['name']);
		$error    = $_FILES['file']['error'];
		$imgups     = "WIMedia/Img/contents/" . basename($_FILES['file']['name']);
