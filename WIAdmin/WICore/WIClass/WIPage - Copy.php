...
<div class="col-lg-2 col-dm-3 col-xs-3 col-sm-3 page">
                            ...
                            <div class="col-lg-2 col-dm-3 col-xs-3 col-sm-3 page">
                              <a class="col-lg-2 col-dm-3 col-xs-3 col-sm-3 edit"><button type="button" class="close" onclick="WIPages.Open(' . $res['id'] . ', `' . $res['name'] . '`)" data-dismiss="modal" aria-hidden="false">&times;</button></a>
                            </div>
...
//include_once  $directory . '/WIInc/edit/' . $page_id . '.php' ;
     // echo  '/WIModule/' .$name.'/'.$name.'.php';
      require_once  $directory . '/WIModule/' .$page.'/'.$page.'.php';
        $page = new $page;

        $page->editPageContent($page);   
    }
