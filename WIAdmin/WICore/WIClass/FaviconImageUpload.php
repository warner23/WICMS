...
if (isset($_FILES)) {
	if (isset($_FILES['file'])) {
		...
		$imgs     = "../../WIMedia/Img/favicon/" . basename($_FILES['file']['name']);
		$vids     = "../../WIMedia/Vid/favicon/" . basename($_FILES['file']['name']);
		$error    = $_FILES['file']['error'];
		$imgups     = "WIMedia/Img/favicon/" . basename($_FILES['file']['name']);
