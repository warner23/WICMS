																													...
																													i=_helpers2.default.merge(Object.assign({},r),{
																														...
																														action:{
																															click:function(e){
																																...
																																o=t.fType;o=o.replace(/s$/,"");
																																var r="editing-"+o,
																																n=t.querySelector("."+o+"-edit");
																																_animation2.default.slideToggle(n,333),"field"===o&&(_animation2.default.slideToggle(n.nextSibling,333),
																																	t.parentElement.classList.toggle("column-"+r)),
																																t.classList.toggle(r)}}}),a=_helpers2.default.merge(Object.assign({},r),{
																																	content:o("remove"),
																																	attrs:{className:["item-remove"]},
																																	meta:{id:"remove"},action:{
																																		click:function(e){
																																...
																																l=_helpers2.default.merge(Object.assign({},r),{
																																	...
																																	meta:{id:"clone"},action:{
																																		click:function(e){
																																			t.clone((0,_utils.closestFtype)(e.target)),
																																			_data2.data.save()}}}),
																																s={rows:{
																																	actionButtons:{
