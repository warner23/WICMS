...
<head>
  ...
  <meta name="theme-color" content="WICM">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/meyer-reset/2.0/reset.min.css" crossorigin="anonymous">
  <link rel="stylesheet" type="text/css" href="WIInc/css/demo.css">
...
<body>
    ...
    <div id="debug-wrap">
      ...
      <nav>
        <ul>
          ...
          <label for="control-filter">Control Filter:</label> <input type="text" id="control-filter" placeholder="ex. text" />
            <!-- <a href="#debug" id="debug-demo" title="Debug">Debug</a> -->
  ...
  <script src="WICore/WIJ/pagebuilder.js"></script>
  <script src="WICore/WIJ/wi.js"></script>
</body>
