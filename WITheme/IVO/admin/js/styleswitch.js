...
$('head link[data-name=layout]').attr('href', 'WITheme/WiCMS/site/css/layout/' + layout + '.css');
}
...
function changeLayout(layout) {
var oldlayout = $.cookie(cookieName, 'layout');
$.cookie(cookieName, layout);
$('head link[data-name=skins]').attr('href', 'WITheme/WICMS/site/css/skins/' + layout + '.css');
