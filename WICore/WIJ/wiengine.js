 ...
 */
wiengine.loadingButton = function(button, loadingText) {
    oldText = button.text();
 ...
 */
wiengine.removeLoadingButton = function (button) {
...
wiengine.displaySuccessMessage = function (parentElement, message) {
 ...
 * @param {String} message Message to be displayed.
 */
wiengine.displayErrorMessage = function(element, message) {
 ...
 */
wiengine.removeErrorMessages = function () {
 ...
 */
wiengine.validateEmail = function (email) {
 ...
 */
wiengine.urlParam = function(name){
