...
class WIDebate 
{
	...
	public function StartChat($userId, $userVoteId, $topic_id)
	{
		...
		if($status === "in_chat"){
			...
			$chatInvite = WIDebate::sendRequestInvite($userId, $userVoteId, $topic_id);
	...
	public function sendRequestInvite($userId, $userVoteId, $topic_id)
	{
		$status = "requested";
