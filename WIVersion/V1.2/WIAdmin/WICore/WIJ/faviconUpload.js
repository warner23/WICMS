  $(document).ready(function() {
    event.preventDefault();
      ...
      function applyAjaxFileUpload(element) {
        $(element).AjaxFileUpload({
          action: "WICore/WIClass/faviconUpload.php",
          ...
          onComplete: function(filename, response) {
            ...
            $("#uploadFavImg").attr("src", "WIMedia/Img/favicon/"+filename);
                  $("#faviconPic").attr("src", "WIMedia/Img/favicon/"+filename);
      $(".cp").attr("id", filename);
    ...
    $("#modal-favicon-upload").addClass("off");
      ...
      applyAjaxFileUpload("#wifaviconupload");
