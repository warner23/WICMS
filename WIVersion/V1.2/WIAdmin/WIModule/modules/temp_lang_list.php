<form class="trans" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">

<label class="trans2" for="lang">Select Language:</label>
				<select class="trans4" id="lang" name="lang" onchange="submitForm()">
    ...
    <option value="ES" <?php if($_GET['lang'] != 'FR' && $_GET['lang'] != 'SJ'){ echo " selected=\"selected\"";} ?> label="Spain">Spain</option>
    ...
    <option value="GB" <?php if($_GET['lang'] != 'FR' && $_GET['lang'] != 'SJ'){ echo " selected=\"selected\"";} ?> label="United Kingdom">United Kingdom</option>
    ...
    <input class="trans3" name="submit" type="submit" value="Translate!" />
</form>