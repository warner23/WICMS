...
$('head link[data-name=layout]').attr('href', 'WITheme/River/site/css/layout/' + layout + '.css');
}
...
function changeLayout(layout) {
$.cookie(cookieName, layout);
$('head link[data-name=skins]').attr('href', 'WITheme/River/site/css/skins/' + layout + '.css');
}
